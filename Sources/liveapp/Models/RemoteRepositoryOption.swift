...
public enum RemoteRepositoryOption {
    ...
    case LiveAppCC
    /// A self-hosted remote repsository for live views to use the specified endpoints. `.SelfHosted(apiURL: "https://api.example.com/", storageURL: "https://storage.example.com/")`.
    case SelfHosted(apiURL: String, storageURL: String)
