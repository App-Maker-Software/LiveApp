...
public final class LiveApp {
    ...
    public static func configureSelfHosted(
        ...
        do {
            try SwiftUIInterpreter.unlock_for_self_hosting(licenseKey: licenseKey, liveAppBundle: liveAppBundle)
            return
        } catch let error as SwiftUIInterpreter.ConfigureError {
    ...
    public static func configure(apiKey: String) {
        ...
        #if INCLUDE_DEVELOPER_TOOLS
        do {
            try SwiftUIInterpreter.unlock_for_live_app_server(apiKey: apiKey, liveAppBundle: liveAppBundle)
            return
        } catch let error as SwiftUIInterpreter.ConfigureError {
            handleConfigureError(error: error)
        } catch {
    ...
    #if INCLUDE_DEVELOPER_TOOLS
    private static func handleConfigureError(error: SwiftUIInterpreter.ConfigureError?) {
        switch error {
